...
- Do not edit plan.md unless maintainers ask.
- Read DEPLOYMENT.md before suggesting Vercel/Supabase changes.
- Next.js version in this repo may differ from training data; check installed Next docs if coding.
